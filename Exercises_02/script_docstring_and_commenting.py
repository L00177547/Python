"""
Script: script_docstring_and_commenting.py
By:Richard Vaughan
Purpose: Script to Calculate my budget and expenditure for this semester
Prerequisites: None.
Tested: On python 3.10 on Windows 11.

Revision history:
Alpha Version: 30SEP22
Notes: Just added Script Docstring and comments.
