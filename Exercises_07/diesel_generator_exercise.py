...
def endurance(fuel_in_litres: float, fuel_consumption_rate: float):
    try:
        ...
        print('Zero division, setting endurance to zero')
        return 0
        ...
        try:
            ...
            while not correct_input:
                try:
                    ...
                    if mins_remaining == 0:
                        print(f"The diesel backup generator is idling")
                        ...
                        print(f"The endurance of the generator is {endurance_min} minutes and"
